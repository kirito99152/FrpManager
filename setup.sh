...
sed -i 's|WorkingDirectory=/root/FrpManager|WorkingDirectory=/opt/proxymanager|' /etc/systemd/system/proxymanager-frps.service
sed -i 's|ExecStart=/opt/frp/frps -c /root/FrpManager/configs/frps.yaml|ExecStart=/opt/frp/frps -c /opt/proxymanager/configs/frps.yaml|' /etc/systemd/system/proxymanager-frps.service
