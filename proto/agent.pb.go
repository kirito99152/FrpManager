...
func (x *ReportResponse) GetLatestVersion() string {
	if x != nil {
...
func (x *ReportResponse) GetUpgradeUrl() string {
	if x != nil {
		return x.UpgradeUrl
	}
	return ""
...
const file_proto_agent_proto_rawDesc = "" +
	...
	"\bservices\x18\x04 \x03(\v2\x10.api.ServiceInfoR\bservices\"\x8c\x01\n" +
	...
	"\rCommandStream\x12\f.api.AgentID\x1a\f.api.Command0\x01B2Z0github.com/kirito99152/FrpManager/internal/apib\x06proto3"
