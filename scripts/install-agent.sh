...
# FrpManager Agent - Professional Install Script
...
echo -e "${GREEN}Starting FrpManager Agent Professional Installation...${NC}"
...
echo "Downloading FRP v0.68.0 from FrpManager Server..."
...
[Unit]
Description=FrpManager Client Agent
...
echo "FrpManager Agent is now managed by systemd."
