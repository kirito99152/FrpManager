...
import (
	...
	"github.com/kirito99152/FrpManager/internal/api"
	"github.com/kirito99152/FrpManager/internal/config"
	"github.com/kirito99152/FrpManager/internal/db"
	"github.com/kirito99152/FrpManager/internal/models"
...
func (h *DashboardHandler) CreateProxy(c *gin.Context) {
	...
	if proxy.ProxyType == "http" || proxy.ProxyType == "https" {
		...
		// Validation: Ensure remote port is not physically listening on the FrpManager Server
...
func buildInstallInstructions(c *gin.Context) string {
	...
	return fmt.Sprintf(`FrpManager quick install
...
echo "FrpManager agent installed successfully."
...
$BaseUrl = %q
$WorkDir = "C:\FrpManager"
$ServiceName = "FrpManagerAgent"
$ServerAddr = %q
$AgentToken = %q
...
if (-not (Get-Service -Name $ServiceName -ErrorAction SilentlyContinue)) {
    ...
    New-Service -Name $ServiceName -BinaryPathName $binPath -DisplayName "FrpManager Agent" -StartupType Automatic | Out-Null
}

Start-Service -Name $ServiceName

Write-Host "FrpManager agent installed successfully."
